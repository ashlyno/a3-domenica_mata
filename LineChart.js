var LineChart = function () {
    ...
    var chart = function (selection) {
        ...
        selection.each(function (data) {
            ...
            var svg = self.selectAll("svg").data([data[0].values]);
            ...
            var yExtent = d3.extent(data[0].values, function (d) { return +d.y });
            ...
            var lines = self.select('.chartG').selectAll('path').data(data, (d) => d.id);
            lines.enter()
                .append('path')
                .attr('class', 'elements')
                .attr('d', function(d){
